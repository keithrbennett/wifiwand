...
describe 'command registry components' do
  describe WifiWand::Commands::Metadata do
  ...
  describe WifiWand::Commands::Base do
    let(:cli) { double('cli') }
    let(:metadata) { WifiWand::Commands::Metadata.new(short_string: 't', long_string: 'test_command') }
    ...
    it 'binds declared same-name attributes from the cli' do
      ...
      model = double('model')
      command_metadata = WifiWand::Commands::Metadata.new(short_string: 'sa', long_string: 'same_attrs')
    ...
    it 'binds mapped attributes from differently named cli readers' do
      ...
      output = StringIO.new
      command_metadata = WifiWand::Commands::Metadata.new(short_string: 'ma', long_string: 'mapped_attrs')
    ...
    it 'inherits binding declarations in subclasses' do
      ...
      model = double('model')
      output = StringIO.new
      command_metadata = WifiWand::Commands::Metadata.new(short_string: 'ca', long_string: 'child_attrs')
  ...
  describe WifiWand::Commands::Registry do
    subject { test_class.new }

    let(:test_class) do
      Class.new do
        include WifiWand::Commands::Registry
