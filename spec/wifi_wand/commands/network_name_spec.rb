...
require_relative '../../../lib/wifi_wand/commands/network_name'

describe WifiWand::Commands::NetworkName do
    ...
    it 'raises a usage-oriented error when extra arguments are provided' do
      ...
      expect { command.call('extra') }
        .to raise_error(WifiWand::ConfigurationError) { |error|
          ...
          expect(error.message).to include('Usage: wifiwand network_name')
