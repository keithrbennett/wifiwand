...
This setup gives wifiwand a stable macOS app identity for permission-sensitive WiFi reads such as current
...
later, and wifiwand does not use it on older macOS versions.
