...
module WifiWand
  module Platforms
    module Mac
      module Helper
        class Setup
          SupportStatus = Bundle::HelperSupportStatus
          ...
          # Delegates to Bundle.ensure_helper_installed so that the
          ...
          private def check_authorization(helper_path, valid)
            ...
            helper_result = Bundle.run_bounded_helper_command(helper_path, 'check-permission')
