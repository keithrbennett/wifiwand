...
#
# Usage (from the exe):
#   exit SetupCli.new(argv: ARGV).run
      ...
      module Helper
        class SetupCli
          ...
          private def perform_reinstall
            ...
            @out_stream.puts "✓ Helper reinstalled at: #{Bundle.installed_bundle_path}"
          ...
          private def execute_steps(steps)
            ...
            if steps.include?(:install_helper)
              ...
              @out_stream.puts "✓ Helper installed at: #{Bundle.installed_bundle_path}"
              print_helper_version_directory_notice
          ...
          private def print_helper_version_directory_notice
            install_dir_count = Bundle.helper_install_dir_count
            return unless install_dir_count > Bundle::VERSION_DIRECTORY_NOTICE_THRESHOLD
