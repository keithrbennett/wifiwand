...
/* ===========================
   ...
   CoreWLAN framework. It is the direct Swift-source runtime path used by wifi-wand via
   ...
   USAGE FROM RUBY
   ---------------
   Called via WifiWand::Platforms::Mac::Helper::SwiftRuntime#connect:
   ...
   ------------------------
   WifiWand::Platforms::Mac::Model#_connect delegates the direct Swift-source path through
