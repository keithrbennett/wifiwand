...
require_relative '../../../../lib/wifi_wand/models/mac_os/network_scanner'

module WifiWand
  describe MacOsNetworkScanner do
    subject(:scanner) do
      described_class.new(
    ...
    let(:helper_client) { instance_double(WifiWand::MacOsHelperClient) }
