# Apply All Automatable Rubocop Changes to the Code Base

### Ensure Rubocop is in the Bundle
...
- Given the repo's .rubocop.yml file, branch from main and implement all the automatable Rubocop fixes that
  can be done.
