...
- Direct Swift source path:
  ...
  `lib/wifi_wand/platforms/mac/helper/swift/WifiNetworkDisconnector.swift`, launched through
  `WifiWand::Platforms::Mac::Helper::SwiftRuntime`, handle connect/disconnect operations.
